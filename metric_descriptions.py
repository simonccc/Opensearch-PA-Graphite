...
def get_working_metric_descriptions():
    ...
    return [
        ...
        MetricDescription(name='Sched_Runtime', agg='min', dimensions=[ 'Operation', ]),
        MetricDescription(name='Sched_Runtime', agg='max', dimensions=[ 'Operation', ]),
        MetricDescription(name='Sched_Runtime', agg='avg', dimensions=[ 'Operation', ]),
        MetricDescription(name='Sched_Waittime', agg='min', dimensions=['Operation', ]),
        MetricDescription(name='Sched_Waittime', agg='max', dimensions=[ 'Operation', ]),
        MetricDescription(name='Sched_Waittime', agg='avg', dimensions=[ 'Operation', ]),
        MetricDescription(name='Sched_CtxRate', agg='min', dimensions=[ 'Operation', ]),
        MetricDescription(name='Sched_CtxRate', agg='max', dimensions=[ 'Operation', ]),
        MetricDescription(name='Sched_CtxRate', agg='avg', dimensions=[ 'Operation', ]),
        ...
        MetricDescription(name='IO_TotThroughput', agg='min', dimensions=[ 'Operation', ]),
        MetricDescription(name='IO_TotThroughput', agg='max', dimensions=[ 'Operation', ]),
        MetricDescription(name='IO_TotThroughput', agg='avg', dimensions=[ 'Operation', ]),
        ...
        MetricDescription(name='IO_TotalSyscallRate', agg='min', dimensions=[ 'Operation', ]),
        MetricDescription(name='IO_TotalSyscallRate', agg='max', dimensions=[ 'Operation', ]),
        MetricDescription(name='IO_TotalSyscallRate', agg='avg', dimensions=[ 'Operation', ]),
