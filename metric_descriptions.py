...
def get_working_metric_descriptions():
    ...
    return [
        ...
        MetricDescription(name='Paging_MajfltRate', agg='min', dimensions=[ 'Operation', ]),
        MetricDescription(name='Paging_MajfltRate', agg='max', dimensions=[ 'Operation', ]),
        MetricDescription(name='Paging_MajfltRate', agg='avg', dimensions=[ 'Operation', ]),
        MetricDescription(name='Paging_MinfltRate', agg='min', dimensions=[ 'Operation', ]),
        MetricDescription(name='Paging_MinfltRate', agg='max', dimensions=[ 'Operation', ]),
        MetricDescription(name='Paging_MinfltRate', agg='avg', dimensions=[ 'Operation', ]),
        MetricDescription(name='Paging_RSS', agg='min', dimensions=[  'Operation', ]),
        MetricDescription(name='Paging_RSS', agg='max', dimensions=[  'Operation', ]),
        MetricDescription(name='Paging_RSS', agg='avg', dimensions=[  'Operation', ]),
